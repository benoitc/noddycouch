...
Database.prototype.all_docs = function(options) {
  var options = options || {};
  ...
  if ( params && params.keys) {
    ...
    var req = this.post("/_all_docs", {keys: keys}, {}, options.params);
  } else {
    var req = this.get("/_all_docs", null, {}, options.params);
  }
...
Database.prototype.view = function(name, options) {
  ...
  if (params && params.keys) {
    var keys = params.keys;
    delete options.params["keys"];
    var req = this.post(docid, {keys: keys}, {}, options.params);
  } else {
    var req = this.get(docid, null, {}, options.params);
  }
